...
![BS结构系统的通信原理2](https://gitcode.net/qq_50848214/image/-/raw/master/41A-A1A-JavaEE-BS结构系统的通信原理2.png)
...
![BS结构系统的角色和协议](https://gitcode.net/qq_50848214/image/-/raw/master/41A-A1A-JavaEE-BS结构系统的角色和协议.png)
...
- 思考：我们自己new的Servlet对象受WEB容器的管理吗？
  ...
  - ![WEB容器中的Map集合](https://gitcode.net/qq_50848214/image/-/raw/master/41A-A1A-JavaEE-WEB容器中的Map集合.png)
